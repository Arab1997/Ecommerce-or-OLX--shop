...
import com.example.ecommerceshop.Model.Cart;
import com.example.ecommerceshop.Prevalent.Prevalent;
import com.example.ecommerceshop.ViewHolder.CartViewHolder;
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if (shippingState.equals("shipped")) {
                        ...
                        Toast.makeText(CartActivity.this, "you can purchase  more products, once you received your first order final", Toast.LENGTH_SHORT).show();
