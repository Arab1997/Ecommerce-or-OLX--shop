...
public class SettingsActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    storageReferencePictureRef = FirebaseStorage.getInstance().getReference().child("Profile pictures");
  ...
  private void uploadImage() {
    ...
    if (imageUri != null) {
      final StorageReference fileRef = storageReferencePictureRef.child(
              Prevalent.currentOnlineUser.getPhone() + ".jpg");
